...
<h2> STEPS: </h2>
 ...
 <p>Clone this repo using command <code>  git clone https://github.com/ArteriusDayne/Wordpress-AWSTerraform.git</code></p>
 <p> Go to project folder         <code>  cd Wordpress-AWSTerraform </code></p>
